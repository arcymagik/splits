...
\section{Losowy algorytm}

Pierwszym testem algorytmu jest mecz z algorytmem wykonuj±cym zupe³nie losowe ruchy. Je¿eli nie napisano inaczej, przez
mecz bêdziemy rozumieæ grê z limitem czasu na ruch wielko¶ci 2 sekund uruchomiony na maszynie students. Test
$\texttt{play\_match}$
...
Wszystkie algorytmy $\texttt{minimax}$, $\texttt{alphabeta}$ oraz $\texttt{alphabeta with transposition table}$ ustawione
na tê sam± g³êboko¶æ obliczaj± warto¶æ minimaksow± tego samego drzewa. Test $\alphabeta\_speeds$ doprowadza grê do przeciêtnego
momentu w fazie przek³adania ¿etonów i uruchamia wszystkie 3 algorytmy na g³êboko¶ci 3.

\section{Granica ufno¶ci}

\section{Monte Carlo Tree Search}

\section{MCTS i Alfabeta}
