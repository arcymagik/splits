...
z ustalon± wag± $N$ (w badaniach u¿yto warto¶ci $N = 10$) i dodajmy ilo¶æ pustych s±siadów stosu,
w którym siê znajduje, jak na rysunku \cite{rys}. Ta warto¶æ stanowi drug±, ulepszon± funkcjê oceniaj±c±.
...
\end{tikzpicture}
\end{center}
\caption{¯etony tego stosu dok³adaj± siê do funkcji oceniaj±cej z warto¶ci± TODO}
\end{figure}
...
zosta³ dok³adnie opisany w \cite{ap96}. Tutaj algorytm przedstawiono w pseudokodzie Algorithm \ref{alg:alphabeta}.
...
DAGiem. Oznacza to, ¿e niektóre pary wêz³ów w drzewie odpowiadaj± tym samym sytuacjom. £atwo zauwa¿yæ, ¿e w grze Splits
musz± siê wtedy one
