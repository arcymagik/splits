...
\begin{abstract}
  ...
  pomóc lepiej zrozumieæ charakter gry Splits.
\end{abstract}
...
zwyciê¿y³ z mistrzem ¶wiata Garry'm Kasparovem.
...
ulepszenia. W ostatnim rozdziale zawarto podsumowanie oraz wnioski z badañ.
...
opisano klasyczny algorytm minimax oraz pochodz±c± od niego alfabetê wraz z usprawnieniami, czyli tablic± transpozycji,
...
by³a wygrywaj±ca przeciwnik pope³ni³ b³±d i ustawi³ nas w takiej.
...
Poni¿ej, w Algorytmie \ref{alg:mcts} zaprezentowano najbardziej klasyczne podej¶cie.
...
Najprostszym jest ustalenie pewnej ustalonej liczby rozgrywek - tak zwanej sta³ej ekspansji lub sta³ej eksploracji,
...
W tabeli \ref{fig:ab_speeds} zaprezentowano czasy potrzebne na ca³kowite przej¶cie drzewa gry do g³êboko¶ci 5,
